...
bandit12@bandit:~$ mkdir /tmp/CTFSol
bandit12@bandit:~$ cp data.txt /tmp/CTFSol/file
bandit12@bandit:~$ cd /tmp/CTFSol
bandit12@bandit:/tmp/CTFSol$ ls
file
bandit12@bandit:/tmp/CTFSol$ xxd -r file > otherfile
bandit12@bandit:/tmp/CTFSol$ ls
file  otherfile
bandit12@bandit:/tmp/CTFSol$ file otherfile
otherfile: gzip compressed data, was "data2.bin", last modified: Tue Oct 16 12:00:23 2018, max compression, from Unix
bandit12@bandit:/tmp/CTFSol$ mv otherfile data.gz
bandit12@bandit:/tmp/CTFSol$ ls
data.gz  file
bandit12@bandit:/tmp/CTFSol$ gunzip data.gz
bandit12@bandit:/tmp/CTFSol$ ls
data  file
bandit12@bandit:/tmp/CTFSol$ file data
data: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/CTFSol$ bunzip2 data
bunzip2: Can't guess original name for data -- using data.out
bandit12@bandit:/tmp/CTFSol$ ls
data.out  file
bandit12@bandit:/tmp/CTFSol$ file data.out
data.out: gzip compressed data, was "data4.bin", last modified: Tue Oct 16 12:00:23 2018, max compression, from Unix
bandit12@bandit:/tmp/CTFSol$ mv data.out data.gz
bandit12@bandit:/tmp/CTFSol$ gunzip data.gz
bandit12@bandit:/tmp/CTFSol$ ls
data  file
bandit12@bandit:/tmp/CTFSol$ file data
...
bandit12@bandit:/tmp/CTFSol$ ls
data  file
bandit12@bandit:/tmp/CTFSol$ man tar
bandit12@bandit:/tmp/CTFSol$ tar -xfv
data  file
bandit12@bandit:/tmp/CTFSol$ tar -xfv data
tar: v: Cannot open: No such file or directory
tar: Error is not recoverable: exiting now
bandit12@bandit:/tmp/CTFSol$ ls
data  file
bandit12@bandit:/tmp/CTFSol$ tar -x data
tar: Refusing to read archive contents from terminal (missing -f option?)
tar: Error is not recoverable: exiting now
bandit12@bandit:/tmp/CTFSol$ tar -xf data
bandit12@bandit:/tmp/CTFSol$ ls
data  data5.bin  file
bandit12@bandit:/tmp/CTFSol$ file data5.bin
data5.bin: POSIX tar archive (GNU)
bandit12@bandit:/tmp/CTFSol$ tar -xf data5.bin
bandit12@bandit:/tmp/CTFSol$ ls
data  data5.bin  data6.bin  file
bandit12@bandit:/tmp/CTFSol$ file data6.bin
data6.bin: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/CTFSol$ mv data6.bin data6.gz
bandit12@bandit:/tmp/CTFSol$ gunzip2 data6.gz
-bash: gunzip2: command not found
bandit12@bandit:/tmp/CTFSol$ bunzip2 data6.gz
bunzip2: Can't guess original name for data6.gz -- using data6.gz.out
bandit12@bandit:/tmp/CTFSol$ ls
data  data5.bin  data6.gz.out  file
bandit12@bandit:/tmp/CTFSol$ file data6.gz.out
data6.gz.out: POSIX tar archive (GNU)
bandit12@bandit:/tmp/CTFSol$ tar -xf data6.gz.out
bandit12@bandit:/tmp/CTFSol$ ls
data  data5.bin  data6.gz.out  data8.bin  file
bandit12@bandit:/tmp/CTFSol$ file data8.bin
data8.bin: gzip compressed data, was "data9.bin", last modified: Tue Oct 16 12:00:23 2018, max compression, from Unix
bandit12@bandit:/tmp/CTFSol$ mv data8.bin data8.gz
bandit12@bandit:/tmp/CTFSol$ gunzip data8.gz
bandit12@bandit:/tmp/CTFSol$ ls
data  data5.bin  data6.gz.out  data8  file
bandit12@bandit:/tmp/CTFSol$ file data8
data8: ASCII text
bandit12@bandit:/tmp/CTFSol$ cat data8
